...
TEST_F(MqttTest, mqtt_client_A_can_subscribe_to_mqtt_publication_from_client_B) {
    ...
    boost::asio::io_context ioc;
    MqttClient mqttClientA{"hello1", "127.0.0.1", 1883, ioc};
    MqttClient mqttClientB{"hello2", "127.0.0.1", 1883, ioc};
...
TEST_F(MqttTest, mqtt_client_receives_persistent_messages_after_subscribe) {
    ...
    boost::asio::io_context ioc;
    MqttClient mqttClientA{"hello1", "127.0.0.1", 1883, ioc, false};
    MqttClient mqttClientB{"hello2", "127.0.0.1", 1883, ioc};
    ...
    MqttClient mqttClientC{"hello1", "127.0.0.1", 1883, ioc, false};
