...
void MosquittoMqttClient::Publish(const Topic& topic, const Message& message, const bool retain) {
    mosquitto_publish(client_.get(), NULL, topic.c_str(), message.size(), message.c_str(), 1, retain);
}
